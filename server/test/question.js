  ...
  test('GET /api/question - get latest questions', (t) => {
    request(app)
      ...
      .end((err, res) => {
        ...
        t.ok(moment(actualBody[0].expirationDate).isValid(), 'Expiration date must be valid');
        t.ok(moment(actualBody[1].creationDate).isValid(), 'Creation date must be valid');
        t.ok(moment(actualBody[1].expirationDate).isValid(), 'Expiration date must be valid');
        t.ok(moment(actualBody[2].creationDate).isValid(), 'Creation date must be valid');
        t.ok(moment(actualBody[2].expirationDate).isValid(), 'Expiration date must be valid');
